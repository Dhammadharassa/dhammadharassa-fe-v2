...
export const StaggeredMenu: React.FC<StaggeredMenuProps> = ({
  ...
  className,
  logoUrl = '/assets/images/DhammadharassaLogo.png',
  menuButtonColor = '#fff',
  ...
  return (
    ...
    <div
      className={`sm-scope z-40 rounded-l-4xl ${isFixed ? 'fixed top-0 left-0 w-screen h-screen overflow-hidden' : 'w-full h-full'}`}
    >
      <div
        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-5">
                ...
                items.map((it, idx) => (
                  <li className="sm-panel-itemWrap relative overflow-hidden leading-none" key={it.label + idx}>
                    <a
                      ...
                      data-index={idx + 1}
                    >
                      <span className="sm-panel-itemLabel inline-block  origin-[50%-100%] will-change-transform">
                        {it.label}
                      </span>
                    </a>
                  </li>
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
             <div className="flex mt-auto pt-8 gap-12 justify-between">
              ...
              <div className="language flex flex-col gap-3">
                <h3 className="sm-socials-title m-0 text-base font-medium [color:var(--sm-accent,#ff0000)]">
                  {t("Navbar.Language-Select")}
                </h3>
                <LocaleSwitcher />
              </div>
             </div>
...
.sm-scope .sm-socials { margin-top: auto; padding-top: 0rem; display: flex; flex-direction: column; gap: 0.75rem; }
